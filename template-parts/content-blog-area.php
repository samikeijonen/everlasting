...
// Blog query args.
$blog_args = apply_filters( 'everlasting_blog_posts_arguments', array(
	'posts_per_page'         => 5,
	'post_type'              => 'post',
	'post_status'            => 'publish',
	...
	<div class="blog-area-section front-page-section section">
		<div class="wrapper">
			<div class="grid-wrapper grid-wrapper-2cl grid-gap">
				...
				$blog_title        = ( 'page' === get_option( 'show_on_front' ) && 0 !== $blog_title_option ) ? get_the_title( absint( $blog_title_option ) ) : esc_html__( 'News', 'everlasting' );
			...
			<div class="news-section">
				<?php
				echo '<h2 class="page-title">' . esc_html__( 'Everlasting Magazine', 'everlasting' ) . '</h2>';
				...
				$magazine_posts = get_transient( 'everlasting_magazine_posts' );
				...
				if ( false === $magazine_posts ) :
					...
					set_transient( 'everlasting_magazine_posts', $magazine_posts, 2 * HOUR_IN_SECONDS );
				endif;
