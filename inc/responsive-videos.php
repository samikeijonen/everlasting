 ...
 * @return string
 */
function everlasting_wrap_embed_html( $html ) {
 ...
 * @return string
 */
function everlasting_maybe_wrap_embed( $html, $url ) {
	...
	$patterns = apply_filters( 'everlasting_maybe_wrap_embed_patterns', $patterns );
	...
	foreach ( $patterns as $pattern ) {
		...
		if ( $do_wrap )
			return everlasting_wrap_embed_html( $html );
		}

return $html;
}
add_filter( 'embed_oembed_html', 'everlasting_maybe_wrap_embed', 10, 2 );
