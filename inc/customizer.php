 ...
 */
function everlasting_customize_register( $wp_customize ) {
...
add_action( 'customize_register', 'everlasting_customize_register' );
 ...
 * @return boolean
 */
function everlasting_is_school_archive() {
 ...
 * @return boolean
 */
function everlasting_is_service_archive() {
